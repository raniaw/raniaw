...
function showfirstname() {
    ...
    document.getElementById('fr-el').innerHTML = firstname; 
    document.getElementById('fr-el').style.fontFamily = "Gothic Centure, Verdana"; 
    document.getElementById('fr-el').style.fontSize = '30px'; 
    return firstname; 
}
function showhide() {
    var myname = showfirstname(); 
    var mysurname = "Wittenberg"; 

    document.getElementById('fr-el').innerHTML = myname; 
    document.getElementById('fv-el').innerHTML = mysurname; 
    // document.getElementById('fv-el').style.fontFamily="Gothic Centure, Verdana";
    document.getElementById('fv-el').style
    document.getElementById('fv-el').style.fontSize = '30px'; 

    if (document.getElementById('fv-el').style.display == 'block' && 
    document.getElementById('fr-el').style.display == 'block') {
        document.getElementById('fv-el').style.display = 'none'; 
        document.getElementById('fr-el').style.display = 'none'; 
        document.getElementById('fr-el').innerHTML = ""; 
        document.getElementById('fv-el').innerHTML = ""; 
    }else {
        myname = showfirstname(); 
        document.getElementById('fv-el').style.display = 'block'; 
        document.getElementById('fr-el').style.display = 'block'; 
        document.getElementById('fv-el').innerHTML =  mysurname; 
        document.getElementById('fr-el').innerHTML = myname ; 
        
        // document.getElementById('fv-el').innerHTML = myname + " " + mysurname; 
    }
}
function showname() {
    var firstname = "Rania"; 
